    ...
    <AnimatePresence>
      {winner && (
        ...
        >
          ...
          >
            <PartyPopper className="mx-auto h-16 w-16 text-brand-secondary mb-4" />
            <h2 className="text-4xl font-bold text-white mb-2">Congratulations!</h2>
            <p className="text-2xl text-brand-primary font-semibold mb-6">{winner === 'player1' ? 'You' : 'Opponent'} won the game!</p>
            <button
              onClick={resetGame}
